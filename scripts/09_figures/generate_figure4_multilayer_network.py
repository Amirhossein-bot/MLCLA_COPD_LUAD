"""
Generate stacked three-layer MLCLA community visualization.
"""
...
def main():
    parser = argparse.ArgumentParser(description="Generate stacked three-layer MLCLA community visualization.")
    parser.add_argument("--input", default=None, help="Input table for figure generation.")
    parser.add_argument("--output", default="results/figures/generate_figure4_multilayer_network.png")
    ...
    if args.input is None:
        ...
        ax.text(0.5, 0.5, "Generate stacked three-layer MLCLA community visualization.\nProvide --input to generate the final figure.", ha="center", va="center")
        ax.axis("off")
