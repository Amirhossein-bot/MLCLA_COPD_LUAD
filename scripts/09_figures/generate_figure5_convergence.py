"""
Generate MLCLA convergence profile from optimization history.
"""
...
def main():
    parser = argparse.ArgumentParser(description="Generate MLCLA convergence profile from optimization history.")
    parser.add_argument("--input", default=None, help="Input table for figure generation.")
    parser.add_argument("--output", default="results/figures/generate_figure5_convergence.png")
    ...
    if args.input is None:
        ...
        ax.text(0.5, 0.5, "Generate MLCLA convergence profile from optimization history.\nProvide --input to generate the final figure.", ha="center", va="center")
        ax.axis("off")
