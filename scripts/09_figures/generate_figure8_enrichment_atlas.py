"""
Generate enrichment/pathway atlas figure.
"""
...
def main():
    parser = argparse.ArgumentParser(description="Generate enrichment/pathway atlas figure.")
    parser.add_argument("--input", default=None, help="Input table for figure generation.")
    parser.add_argument("--output", default="results/figures/generate_figure8_enrichment_atlas.png")
