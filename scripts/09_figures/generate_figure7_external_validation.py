...
def main():
    parser = argparse.ArgumentParser(description="Generate external validation summary figure.")
    parser.add_argument("--input", default=None, help="Input table for figure generation.")
    parser.add_argument("--output", default="results/figures/generate_figure7_external_validation.png")
